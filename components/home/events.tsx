...
export default function EventList() {
  ...
  return (
    <section className="font-mono flex flex-col justify-center output min-h-screen bg-[#001408]" id="events">
            ...
            <div
              ...
              <Drawer>
                ...
                <DrawerContent className="font-mono text-sm">
                  <DrawerHeader>
                    <DrawerTitle className="text-4xl">{eventinf.name}</DrawerTitle>
                    <DrawerDescription>
